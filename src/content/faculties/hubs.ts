...
const FCML_SECTIONS: HubSection[] = [
  ...
  },
  {
    ...
    leadBg: "Деканат в Ректората.",
    leadEn: "Dean's office in the Rectorate.",
    bodyBg: [
      "София, Ректорат, централно крило, каб. 231.",
      "Декан — проф. д-р Гергана Петкова, каб. 232.",
    ],
    bodyEn: [
      "Sofia, Rectorate, central wing, room 231.",
      "Dean — Prof. Gergana Petkova, PhD, room 232.",
    ],
  },
  {
    slug: "departments",
